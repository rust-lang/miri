...
fn main() {
    let path = utils::prepare_with_content("fail-libc-read-and-uninit.txt", &[1u8, 2, 3]);
    ...
    unsafe {
        ...
        buf.assume_init(); //~ERROR: Undefined Behavior: constructing invalid value at .value[1]: encountered uninitialized memory, but expected an integer
