...
#
# Taken on 2022-09-19 from https://github.com/gitgitgadget/git/pull/493
# because that PR appears to be dead and without the patches from that PR,
# subtrees do not work at all on the rustc repo.
#
if test $# -eq 0
then
	set -- -h
