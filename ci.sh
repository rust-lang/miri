...
case $HOST_TARGET in
  x86_64-unknown-linux-gnu)
    ...
    MIRI_TEST_TARGET=x86_64-unknown-freebsd run_tests_minimal hello integer vec panic/panic concurrency/simple atomic data_race env/var panic/concurrent-panic
