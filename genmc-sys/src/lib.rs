...
mod ffi {
    ...
    struct GenmcParams {
        ...
        /// This should never affect the results for correct programs, but may affect the runtime.
        /// If a program contains multiple errors, the scheduling policy may affect which one is reported.
    ...
    struct EstimationResult {
        ...
        blocked_execs: u64,
        /// Number of encounteded moot executions during the estimation.
        /// NOTE: moot executions are only counted in debug mode.
        moot_execs: u64,
    }
