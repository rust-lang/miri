...
case $HOST_TARGET in
  ...
  i686-unknown-linux-gnu)
    ...
    UNIX="hello panic/unwind concurrency/simple atomic libc-mem libc-misc libc-random env num_cpus" # the things that are very similar across all Unixes, and hence easily supported there
