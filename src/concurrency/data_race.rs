...
pub enum NaReadType {
    ...
    // An implicit read generated by a retag (or elsewhere in the aliasing model).
    AliasingImplicit,
}
...
impl NaReadType {
    fn description(self) -> &'static str {
        match self {
            ...
            NaReadType::AliasingImplicit => "implicit read from the aliasing model",
        }
    }
}
...
pub enum NaWriteType {
    ...
    // An implicit write generated by a retag (or elsewhere in the aliasing model).
    AliasingImplicit,
...
impl NaWriteType {
    fn description(self) -> &'static str {
        match self {
            ...
            NaWriteType::AliasingImplicit => "implicit write from the aliasing model",
...
impl AccessType {
    ...
    fn is_aliasing_implicit(self) -> bool {
        matches!(
            self,
            AccessType::NaRead(NaReadType::AliasingImplicit)
                | AccessType::NaWrite(NaWriteType::AliasingImplicit)
        )
    }
}
...
impl VClockAlloc {
    ...
    fn report_data_race<'tcx>(
        ...
        Err(err_machine_stop!(TerminationInfo::DataRace {
            involves_non_atomic,
            extra,
            aliasing_implicit_explain: access.is_aliasing_implicit()
                || other_access.is_aliasing_implicit(),
            ptr: ptr_dbg,
            op1: RacingOp {
