...
impl<'tcx> NewPermission {
    ...
    fn from_ref_ty(
        ...
        Some(Self { zero_size: false, initial_state, protector, should_do_initial_read })
    }
...
trait EvalContextPrivExt<'tcx>: crate::MiriInterpCxExt<'tcx> {
    ...
    fn tb_reborrow(
        ...
        if new_perm.should_do_initial_read {
        ...
        if range.size.bytes() > 0 && new_perm.should_do_initial_read {
